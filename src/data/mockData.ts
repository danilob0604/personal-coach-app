  ...
  splits: [
    {
      ...
      exercises: [
        ...
        },
        {
          ...
          targetRPE: 8,
          tempo: '2-0-1-0',
          trainerNotes: 'Non inarcare la zona lombare, serra i glutei.',
          sets: [
        ...
        },
        {
          ...
          targetRPE: 9,
          tempo: '2-1-1-0',
          trainerNotes: 'Movimento continuo senza pause a carico controllato.',
          sets: [
...
export const INITIAL_ATHLETES: Athlete[] = [
  ...
  },
  {
    ...
    injuriesOrNotes: 'Pacchetto 10 settimane in scadenza questa domenica.'
  },
  {
    id: 'ath-8',
